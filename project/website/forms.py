...
class AddRecordForm(forms.ModelForm):
    task = forms.CharField(required=True, widget=forms.widgets.TextInput(
        attrs={"placeholder": "Task you have to do", "class": "form-control"}), label="")
    task_description = forms.CharField(required=True, widget=forms.widgets.TextInput(
        attrs={"placeholder": "Describe how you gonna do it!", "class": "form-control"}), label="")
